...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/iam-smart` | `npm install @voxgig-sdk/iam-smart` |
| Python | `voxgig-sdk-iam-smart` | `pip install voxgig-sdk-iam-smart` |
| PHP | `voxgig-sdk/iam-smart` | `composer require voxgig-sdk/iam-smart` |
| Golang | `github.com/voxgig-sdk/iam-smart-sdk/go` | `go get github.com/voxgig-sdk/iam-smart-sdk/go` |
| Ruby | `voxgig-sdk-iam-smart` | `gem install voxgig-sdk-iam-smart` |
| Lua | `voxgig-sdk-iam-smart` | `luarocks install voxgig-sdk-iam-smart` |
