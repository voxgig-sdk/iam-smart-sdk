...
|---|---|---|
| `ts/` | @voxgig-sdk/iam-smart-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/iam-smart-sdk \
      --repository voxgig-sdk/iam-smart-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/iam-smart-sdk` shows it, and
`npm trust revoke @voxgig-sdk/iam-smart-sdk --id=<id>` removes it.
