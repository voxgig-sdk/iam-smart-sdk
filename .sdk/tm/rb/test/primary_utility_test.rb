...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = IamSmartOmni.make_runner(TEST_JSON_FILE, IamSmartSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : IamSmartOmni.errify(err)
    end
