...
// IamSmart SDK streaming feature
...
class IamSmartStreamingFeature extends IamSmartBaseFeature
{
    ...
    private function _iterate(IamSmartResult $result): \Generator
    {
    ...
    private function _streamable(IamSmartContext $ctx): bool
    {
