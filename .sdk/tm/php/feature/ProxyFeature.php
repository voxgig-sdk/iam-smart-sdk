...
class IamSmartProxyFeature extends IamSmartBaseFeature
{
    ...
    public function init(IamSmartContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (IamSmartContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
