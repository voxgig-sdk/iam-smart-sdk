...
class IamSmartCacheFeature extends IamSmartBaseFeature
{
    ...
    private function _through(IamSmartContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
