...
// IamSmart SDK ratelimit feature
...
class IamSmartRatelimitFeature extends IamSmartBaseFeature
{
    ...
    private function _acquire(IamSmartContext $ctx): void
    {
    ...
    private function _track(IamSmartContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
