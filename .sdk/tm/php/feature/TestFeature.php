...
// IamSmart SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IamSmartTestFeature extends IamSmartBaseFeature
{
    ...
    public function init(IamSmartContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IamSmartContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IamSmartContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IamSmartContext $ctx, $op, $args): array
    {
