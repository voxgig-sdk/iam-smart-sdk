...
class IamSmartRbacFeature extends IamSmartBaseFeature
{
    ...
    private function _required(IamSmartContext $ctx): ?string
    {
    ...
    private function _reject(IamSmartContext $ctx, string $required): void
    {
    ...
    private function _track(IamSmartContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
