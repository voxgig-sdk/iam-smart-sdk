...
// IamSmart SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IamSmartMakeRequest
{
    public static function call(IamSmartContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IamSmartResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IamSmartResponse($fetched);
        } else {
