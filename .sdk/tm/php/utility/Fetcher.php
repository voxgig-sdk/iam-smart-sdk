...
// IamSmart SDK utility: fetcher

class IamSmartFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IamSmartSDK/1.0)';
    ...
    public static function call(IamSmartContext $ctx, string $fullurl, array $fetchdef): array
    {
