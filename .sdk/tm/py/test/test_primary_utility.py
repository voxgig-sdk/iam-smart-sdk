...
from projectname_sdk import IamSmartSDK
from projectname_sdk.core.spec import IamSmartSpec
from projectname_sdk.core.result import IamSmartResult
from projectname_sdk.core.response import IamSmartResponse
from projectname_sdk.core.operation import IamSmartOperation
from projectname_sdk.core.error import IamSmartError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IamSmartBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = IamSmartSDK.test(None, None)
        ...
        class TestInitFeature(IamSmartBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IamSmartBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IamSmartSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IamSmartSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IamSmartSDK.test(None, setup_opts)
