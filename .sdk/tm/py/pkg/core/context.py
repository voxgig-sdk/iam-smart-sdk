...
from projectname_sdk.core.control import IamSmartControl
...
class IamSmartContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, IamSmartResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IamSmartResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IamSmartError(code, msg, self)
