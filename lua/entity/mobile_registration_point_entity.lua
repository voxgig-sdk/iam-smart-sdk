-- IamSmart SDK MobileRegistrationPoint entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local MobileRegistrationPointEntity = {}
MobileRegistrationPointEntity.__index = MobileRegistrationPointEntity


function MobileRegistrationPointEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MobileRegistrationPointEntity)
  self._name = "mobile_registration_point"
  self._client = client
...
function MobileRegistrationPointEntity:get_name()
  return self._name
end


function MobileRegistrationPointEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MobileRegistrationPointEntity.new(self._client, opts)
end
...
function MobileRegistrationPointEntity:mark_deleted()
  self._deleted = true
end


function MobileRegistrationPointEntity:deleted()
  return true == self._deleted
end


function MobileRegistrationPointEntity:data_set(args)
  if args ~= nil then
...
function MobileRegistrationPointEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MobileRegistrationPointEntity:match_set(args)
  if args ~= nil then
...
function MobileRegistrationPointEntity:match_get()
...
function MobileRegistrationPointEntity:stream(action, args, callopts)
...
---@param reqmatch MobileRegistrationPointListMatch
---@param ctrl? table
---@return MobileRegistrationPoint[]
---@return string? err
function MobileRegistrationPointEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MobileRegistrationPointEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return MobileRegistrationPointEntity
