...
local RegistrationServiceCounterEntity = {}
RegistrationServiceCounterEntity.__index = RegistrationServiceCounterEntity


function RegistrationServiceCounterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RegistrationServiceCounterEntity)
  self._name = "registration_service_counter"
  self._client = client
...
function RegistrationServiceCounterEntity:get_name()
  return self._name
end


function RegistrationServiceCounterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RegistrationServiceCounterEntity.new(self._client, opts)
end
...
function RegistrationServiceCounterEntity:mark_deleted()
  self._deleted = true
end


function RegistrationServiceCounterEntity:deleted()
  return true == self._deleted
end


function RegistrationServiceCounterEntity:data_set(args)
  if args ~= nil then
...
function RegistrationServiceCounterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RegistrationServiceCounterEntity:match_set(args)
  if args ~= nil then
...
function RegistrationServiceCounterEntity:match_get()
...
function RegistrationServiceCounterEntity:stream(action, args, callopts)
...
function RegistrationServiceCounterEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return RegistrationServiceCounterEntity
