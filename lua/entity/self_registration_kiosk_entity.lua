...
local SelfRegistrationKioskEntity = {}
SelfRegistrationKioskEntity.__index = SelfRegistrationKioskEntity


function SelfRegistrationKioskEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SelfRegistrationKioskEntity)
  self._name = "self_registration_kiosk"
  self._client = client
...
function SelfRegistrationKioskEntity:get_name()
  return self._name
end


function SelfRegistrationKioskEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SelfRegistrationKioskEntity.new(self._client, opts)
end
...
function SelfRegistrationKioskEntity:mark_deleted()
  self._deleted = true
end


function SelfRegistrationKioskEntity:deleted()
  return true == self._deleted
end


function SelfRegistrationKioskEntity:data_set(args)
  if args ~= nil then
...
function SelfRegistrationKioskEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SelfRegistrationKioskEntity:match_set(args)
  if args ~= nil then
...
function SelfRegistrationKioskEntity:match_get()
...
function SelfRegistrationKioskEntity:stream(action, args, callopts)
...
function SelfRegistrationKioskEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return SelfRegistrationKioskEntity
