...
local IamSmartSDK = {}
IamSmartSDK.__index = IamSmartSDK
...
IamSmartSDK._make_feature = _make_feature


function IamSmartSDK.new(options)
  local self = setmetatable({}, IamSmartSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function IamSmartSDK:options_map()
...
function IamSmartSDK:get_utility()
  return Utility.copy(self._utility)
end


function IamSmartSDK:get_root_ctx()
  return self._rootctx
end


function IamSmartSDK:prepare(fetchargs)
...
function IamSmartSDK:direct(fetchargs)
...
-- by passing it.
function IamSmartSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function IamSmartSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "IamSmartSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function IamSmartSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = IamSmartSDK.new(sdkopts)
  sdk.mode = "test"
