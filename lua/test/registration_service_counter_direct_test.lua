...
describe("RegistrationServiceCounterDirect", function()
  it("should direct-list-registration_service_counter", function()
    local setup = registration_service_counter_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-registration_service_counter", setup.live and "live" or "unit")
...
function registration_service_counter_direct_setup(mockres)
