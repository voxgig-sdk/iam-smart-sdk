...
describe("SelfRegistrationKioskDirect", function()
  it("should direct-list-self_registration_kiosk", function()
    local setup = self_registration_kiosk_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-self_registration_kiosk", setup.live and "live" or "unit")
...
function self_registration_kiosk_direct_setup(mockres)
