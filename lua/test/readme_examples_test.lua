...
local SDK_MODULE = "iam-smart_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["mobile_registration_point"] = { ["test01"] = { id = "test01" } }, ["registration_service_counter"] = { ["test01"] = { id = "test01" } }, ["self_registration_kiosk"] = { ["test01"] = { id = "test01" } } } }'
