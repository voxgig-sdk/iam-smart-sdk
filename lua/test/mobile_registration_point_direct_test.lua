...
describe("MobileRegistrationPointDirect", function()
  it("should direct-list-mobile_registration_point", function()
    local setup = mobile_registration_point_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-mobile_registration_point", setup.live and "live" or "unit")
...
function mobile_registration_point_direct_setup(mockres)
