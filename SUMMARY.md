...
Results: Successful response containing mobile registration point locations.
...
Results: Successful response containing registration service counter locations.
...
Results: Successful response containing self-registration kiosk locations.
...
| --- | --- | --- | --- |
| MobileRegistrationPoint | `list` | `GET /open_data/iam_smart/mobile-registration-points` | See reference |
| RegistrationServiceCounter | `list` | `GET /open_data/iam_smart/registration-service-counters` | See reference |
| SelfRegistrationKiosk | `list` | `GET /open_data/iam_smart/self-registration-kiosks` | See reference |

## Connect to the API

- Production server: `https://www.digitalpolicy.gov.hk`
...
- `iam-smart_list`: List records for an entity. Supported entities: `mobile_registration_point`, `registration_service_counter`, `self_registration_kiosk`.
- `iam-smart_load`: Load one record for an entity. No active entity supports this operation.
