# IamSmart SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IamSmartSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IamSmartSDK(...) and IamSmartSDK.test(...) become
#      IamSmartSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "iamsmart_sdk"
_SDK_CLASS = "IamSmartSDK"
...
_ENTITIES = {
    "MobileRegistrationPoint": "mobile_registration_point",
    "RegistrationServiceCounter": "registration_service_counter",
    "SelfRegistrationKiosk": "self_registration_kiosk",
}
