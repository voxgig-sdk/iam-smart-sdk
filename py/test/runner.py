...
class IamSmartTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IamSmartTestRunner.getenv("IAMSMART_TEST_LIVE")
        override = IamSmartTestRunner.getenv("IAMSMART_TEST_OVERRIDE")
        ...
        explain = IamSmartTestRunner.getenv("IAMSMART_TEST_EXPLAIN")
