...
class IamSmartTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IamSmartTestRunner.getenv("IAM_SMART_TEST_LIVE")
        override = IamSmartTestRunner.getenv("IAM_SMART_TEST_OVERRIDE")
        ...
        explain = IamSmartTestRunner.getenv("IAM_SMART_TEST_EXPLAIN")
