...
class SelfRegistrationKioskEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SelfRegistrationKioskEntity(self._client, opts)
    ...
    def data_get(self) -> SelfRegistrationKiosk:
    ...
    def match_get(self) -> SelfRegistrationKiosk:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SelfRegistrationKiosk]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SelfRegistrationKiosk().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
