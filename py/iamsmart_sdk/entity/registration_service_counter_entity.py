...
from iamsmart_sdk.iamsmart_types import (
    RegistrationServiceCounter,
    RegistrationServiceCounterListMatch,
)
...
class RegistrationServiceCounterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegistrationServiceCounterEntity(self._client, opts)
    ...
    def data_get(self) -> RegistrationServiceCounter:
    ...
    def match_get(self) -> RegistrationServiceCounter:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[RegistrationServiceCounter]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.RegistrationServiceCounter().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
