...
class MobileRegistrationPointEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MobileRegistrationPointEntity(self._client, opts)
    ...
    def data_get(self) -> MobileRegistrationPoint:
    ...
    def match_get(self) -> MobileRegistrationPoint:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MobileRegistrationPoint]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MobileRegistrationPoint().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
