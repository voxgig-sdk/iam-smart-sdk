...
from iamsmart_sdk.utility import register

# Load features
from iamsmart_sdk.feature.base_feature import IamSmartBaseFeature
from iamsmart_sdk.features import _has_feature, _make_feature
...
class IamSmartSDK:
    ...
    def get_utility(self):
        return IamSmartUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("IamSmartSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def MobileRegistrationPoint(self, data=None) -> "MobileRegistrationPointEntity":
        ...
        from iamsmart_sdk.entity.mobile_registration_point_entity import MobileRegistrationPointEntity
    ...
    def RegistrationServiceCounter(self, data=None) -> "RegistrationServiceCounterEntity":
        ...
        from iamsmart_sdk.entity.registration_service_counter_entity import RegistrationServiceCounterEntity
    ...
    def SelfRegistrationKiosk(self, data=None) -> "SelfRegistrationKioskEntity":
        ...
        from iamsmart_sdk.entity.self_registration_kiosk_entity import SelfRegistrationKioskEntity
