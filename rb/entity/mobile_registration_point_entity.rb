...
class MobileRegistrationPointEntity
  def initialize(client, entopts = nil)
    ...
    @_name = "mobile_registration_point"
    @_client = client
  ...
  def make
    opts = @_entopts.dup
    MobileRegistrationPointEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [MobileRegistrationPointListMatch, Hash, nil] match filter (any subset of
  #   MobileRegistrationPoint fields); defaults to nil, treated as an empty match that lists all.
