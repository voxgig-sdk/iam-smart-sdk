...
class SelfRegistrationKioskEntity
  ...
  def make
    opts = @_entopts.dup
    SelfRegistrationKioskEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [SelfRegistrationKioskListMatch, Hash, nil] match filter (any subset of
  #   SelfRegistrationKiosk fields); defaults to nil, treated as an empty match that lists all.
