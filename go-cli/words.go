...
func registerSDKWords(r *eng.Registry, client *sdk.IamSmartSDK) {
...
func runOp(client *sdk.IamSmartSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
