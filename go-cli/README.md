...
AQL-driven CLI and REPL for the IamSmart SDK. Positional arguments are
...
./iam-smart-cli load 1 mobile_registration_point
./iam-smart-cli load '{id:1}' mobile_registration_point
