...
const testSeed = `map[string]any{"entity": map[string]any{"mobile_registration_point": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "registration_service_counter": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "self_registration_kiosk": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
