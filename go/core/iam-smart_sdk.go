...
func (sdk *IamSmartSDK) OptionsMap() map[string]any {
...
func (sdk *IamSmartSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *IamSmartSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *IamSmartSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IamSmartSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *IamSmartSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *IamSmartSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("IamSmartSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *IamSmartSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *IamSmartSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("IamSmartSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
