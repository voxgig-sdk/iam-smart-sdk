# IamSmart Golang SDK Reference

Complete API reference for the IamSmart Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *IamSmartSDK`
...
#### `MobileRegistrationPoint(data map[string]any) IamSmartEntity`

Create a new `MobileRegistrationPoint` entity instance. Pass `nil` for no initial data.

#### `RegistrationServiceCounter(data map[string]any) IamSmartEntity`

Create a new `RegistrationServiceCounter` entity instance. Pass `nil` for no initial data.

#### `SelfRegistrationKiosk(data map[string]any) IamSmartEntity`
