...
// IamSmart SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IamSmartSDK::test)
...
{
    private const SDK_CLASS = 'IamSmartSDK';
    ...
    private const SDK_BASE = 'iamsmart_sdk';
