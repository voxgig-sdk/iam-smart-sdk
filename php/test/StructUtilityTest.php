...
// IamSmart SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IamSmartOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IamSmartOmni::structfix($now, Struct::undef()))
                        !== json_encode(IamSmartOmni::structfix($val, Struct::undef()))) {
