...
class IamSmartGraphql
{
    ...
    // equivalent.
    public static function body(IamSmartContext $ctx): mixed
    {
    ...
    public static function errors(IamSmartContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
