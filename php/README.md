...
The PHP SDK for the IamSmart API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->MobileRegistrationPoint(null)->list(null, null);
...
[$result, $err] = $client->IamSmart(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── iamsmart_sdk.php          -- Main SDK class
...
The main class (`iamsmart_sdk.php`) exports the SDK class
