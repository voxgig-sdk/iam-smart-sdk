...
// IamSmart SDK SelfRegistrationKiosk entity
...
class SelfRegistrationKioskEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "self_registration_kiosk";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new SelfRegistrationKioskEntity($this->_client, $opts);
    }

    /**
     * @param SelfRegistrationKiosk|array $args SelfRegistrationKiosk data (assoc-array) to store.
     */
    ...
    /**
     * @return SelfRegistrationKiosk|array The current SelfRegistrationKiosk data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SelfRegistrationKiosk fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SelfRegistrationKiosk fields).
     */
     ...
     *
     * @param SelfRegistrationKioskListMatch|array|null $reqmatch Match filter (any subset
     *   of SelfRegistrationKiosk fields) as an assoc-array; SelfRegistrationKioskListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SelfRegistrationKiosk[]|array A list of SelfRegistrationKiosk items as assoc-arrays at
