...
class IamSmartTimeoutFeature extends IamSmartBaseFeature
{
    ...
    private function _with_timeout(IamSmartContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IamSmartContext $_ctx, float $ms): void
    {
        $client = $this->client;
