...
// IamSmart SDK clienttrack feature
...
class IamSmartClienttrackFeature extends IamSmartBaseFeature
{
    ...
    public function PostConstruct(IamSmartContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'IamSmart-SDK';
