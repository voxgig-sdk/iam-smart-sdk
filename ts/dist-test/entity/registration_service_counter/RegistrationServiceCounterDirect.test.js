...
(0, node_test_1.describe)('RegistrationServiceCounterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-registration_service_counter', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-registration_service_counter', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.IAM_SMART_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'IAM_SMART_TEST_REGISTRATION_SERVICE_COUNTER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.IamSmartSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['IAM_SMART_TEST_REGISTRATION_SERVICE_COUNTER_ENTID'];
    ...
    const client = new __1.IamSmartSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RegistrationServiceCounterDirect.test.js.map