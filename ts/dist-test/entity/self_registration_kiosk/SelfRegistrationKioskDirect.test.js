...
(0, node_test_1.describe)('SelfRegistrationKioskDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-self_registration_kiosk', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-self_registration_kiosk', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IAM_SMART_TEST_SELF_REGISTRATION_KIOSK_ENTID'];
...
//# sourceMappingURL=SelfRegistrationKioskDirect.test.js.map