...
(0, node_test_1.describe)('MobileRegistrationPointDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-mobile_registration_point', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-mobile_registration_point', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['IAM_SMART_TEST_MOBILE_REGISTRATION_POINT_ENTID'];
...
//# sourceMappingURL=MobileRegistrationPointDirect.test.js.map