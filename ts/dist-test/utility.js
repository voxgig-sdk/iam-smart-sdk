...
function envOverride(m) {
    if ('TRUE' === process.env.IAM_SMART_TEST_LIVE ||
        'TRUE' === process.env.IAM_SMART_TEST_OVERRIDE) {
    ...
    m.IAM_SMART_TEST_EXPLAIN = process.env.IAM_SMART_TEST_EXPLAIN || m.IAM_SMART_TEST_EXPLAIN;
    return m;
}
